...
```
> This can be changed later on using privileged `set_param` function. Read more in our guides [Set Params](https://guide.eoscostarica.io/docs/blockchain-web3/eos-learn/important-functions#set_params).
