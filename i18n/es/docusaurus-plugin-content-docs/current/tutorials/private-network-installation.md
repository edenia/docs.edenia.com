...
```
> Esto puede ser cambiado más adelante utilizando la función privilegiada `set_param`. Puedes ver más en nuestras guías [Funciones Importantes en EOSIO](https://docs.edenia.com/es/docs/aprender-eosio/funciones-importantes#docsNav)
