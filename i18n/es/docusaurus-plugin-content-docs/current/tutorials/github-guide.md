...
<img alt="Logo de interfaz de línea de comandos GitHub CLI mostrando operaciones Git basadas en terminal y herramientas de gestión de repositorios" src={ useBaseUrl( 'img/LogosGitHub/GitHub-CLI.webp' )} />
...
<img alt="Logo de aplicación GitHub Desktop mostrando interfaz gráfica de usuario para gestión de repositorios Git y control de versiones" src={ useBaseUrl( 'img/LogosGitHub/GitHub-Desktop.webp' )} />
...
<img alt="Logo de aplicación móvil GitHub mostrando interfaz de smartphone para gestión de repositorios y desarrollo colaborativo en dispositivos móviles" src={ useBaseUrl( 'img/LogosGitHub/GitHub-Movil.webp' )} />
...
<img alt="Logo de terminal Git Bash mostrando interfaz de línea de comandos de Windows para operaciones de control de versiones Git y gestión de repositorios" src={ useBaseUrl( 'img/LogosGitHub/GitHub-Bash.webp' )} />
