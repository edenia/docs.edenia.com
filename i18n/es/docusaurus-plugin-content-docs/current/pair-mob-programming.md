...
<img alt="Dos desarrolladores trabajando juntos en programación en pareja"  src={ useBaseUrl( 'img/metodosProgramacion/PairProgramming.webp' )} /> </div>
...
<div style={{  textAlign: "center" }}>
<img alt="Múltiples desarrolladores colaborando en una sesión de programación en grupo" width="70%" src={ useBaseUrl( 'img/metodosProgramacion/MobProgramming.webp' )} /> </div>
